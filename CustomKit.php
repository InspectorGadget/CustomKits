...
class CustomKit extends PluginBase implements Listener {
	...
	public function Infinity(Player $player) {
		...
		// Item gather
		$ds = Item::getItem(276, 0, 1); // D Sword - line 117
		$h = Item::getItem(310, 0, 1); // D Helmet
		$c = Item::getItem(311, 0, 1); // D Chestpiece
		$l = Item::getItem(312, 0, 1); // D Legging
		$b = Item::getItem(313, 0, 1); // D Boot
		// close Item gather
		
		// renaming
		$ds->setCustomName("§l§f[KIT] §r§bInfinity\n§c50% chance of Nausea Effect on others!\nSharpness II");
	...
	public function Legendary(Player $player) {
		...
		// Item Gather
		$ds = Item::getItem(276, 0, 1); // D Sword
		$h = Item::getItem(310, 0, 1); // D Helmet
		$c = Item::getItem(311, 0, 1); // D Chestpiece
		$l = Item::getItem(312, 0, 1); // D Legging
		$b = Item::getItem(313, 0, 1); // D Boot
		...
		//renaming
		$ds->setCustomName("§l§f[KIT] §cLegendary\n§e50% chance of Wither Effect on others\n§a75% chance of Confusing others");
		...
		if($enable === true) {
			$player->sendMessage("§f§l[§eXeon§f] You have successfully purchased a kit named Legendary!");
		}
		else {
